...
//        userStautsEditText = findViewById(R.id.userProfileStatus);
//
...
//                mProgress.show();
//
//                StorageReference mChildStorage = mStorageRef.child("User_Profile_picture").child(imageHoldUri.getLastPathSegment());
