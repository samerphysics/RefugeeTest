...
public class SellServiceActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void sellServiceUpload() {
        ...
        mUserDatabase = FirebaseDatabase.getInstance().getReference().child("Sell_Service").child(Objects.requireNonNull(mAuth.getCurrentUser()).getUid());
        ...
        if (imageHoldUri != null) {
            ...
            StorageReference mChildStorage = mStorageRef.child("sell_service_picture").child(Objects.requireNonNull(imageHoldUri.getLastPathSegment()));
//                                String profilePicUrl = imageHoldUri.getLastPathSegment();
            ...
            mChildStorage.putFile(imageHoldUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    mUserDatabase.child("sell_title").setValue(sell_title);
                    mUserDatabase.child("sell_description").setValue(sell_description);
                    mUserDatabase.child("sell_price").setValue(sell_price);
                    mUserDatabase.child("sell_time").setValue(sell_time);
